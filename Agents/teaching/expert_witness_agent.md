...
- **Technology Evidence Integrity and Preservation**: Advising on the preservation, collection, analysis, and presentation of digital/electronic evidence in compliance with the Electronic Transactions Act, No. 8 of 2011 (ss. 7-8 on authenticity and admissibility of data messages and electronic records), the Electronic Transactions Regulations, S.I. 42 of 2013, the Computer Misuse Act 2011, and best practices for digital forensics (including chain of custody, forensic imaging, metadata preservation, and evidence integrity verification). Note: the Uganda Evidence Act's section 78 concerns the genuineness of certified copies and is NOT the electronic-evidence provision.

## Inputs
- **Uganda Procedural and Evidentiary Law**: Uganda Evidence Act (Cap 6, Laws of Uganda) particularly Sections 43-48 (opinion of experts), Sections 101-103 (burden of proof), and Sections 24-31 (relevance and admissibility); the Electronic Transactions Act, No. 8 of 2011, ss. 7-8 and the Electronic Transactions Regulations, S.I. 42 of 2013 (the correct anchors for admissibility, authenticity, and evidential weight of electronic records — the Evidence Act's s.78 concerns the genuineness of certified copies and is NOT an electronic-evidence provision); Civil Procedure Rules (SI 71-1) particularly Order 12 (expert evidence) and Order 13 (affidavit evidence); Criminal Procedure Act; Practice Directions from the High Court Commercial Division, the Supreme Court, and specialized tribunals.
...
- **Electronic Evidence in Uganda**: Electronic records are admitted and weighed under the Electronic Transactions Act, No. 8 of 2011 — s.7 (authenticity of a data message), s.8 (admissibility and evidential weight, including the best-evidence rule in s.8(1)(b), the burden of proving authenticity in s.8(2), and the ordinary-course presumption in s.8(5)(c)) — together with the Electronic Transactions Regulations, S.I. 42 of 2013, reg. 3 (proving authenticity). Computer-generated records do NOT depend on any "electronic evidence" section of the Evidence Act: its s.78 is about the genuineness of certified copies.
...
- **Essential Primary Sources**:
  - Uganda Evidence Act (Cap 6) — Sections 43-48 (opinion of experts), 101-103 (burden of proof)
  - Electronic Transactions Act, No. 8 of 2011 — Sections 7-8 (authenticity, admissibility, and evidential weight of electronic records)
